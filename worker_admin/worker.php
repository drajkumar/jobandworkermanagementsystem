...
<body>
					...
					<div class="panel-body">
						<table class="table table-striped">
						    ...
						    <tr>
						        ...
						        <th data-field="name"  data-sortable="true">Balence</th>
						        <th data-field="name"  data-sortable="true">Join Date</th>
						    ...
						    <tr>
                                ...
                                $admin = new Admin();
                                $x = 0;
                                  $admin_users = $admin->selectAllUid('user_account', 'user_id');
                                  foreach ($admin_users as $key => $value):
                               	$x++;  
                               	 ?>
						        <td><?php echo $x;  ?></td> 
						        <td><?php  echo $admin_users[$key]['firstname'] ;?>&nbsp;<?php  echo $admin_users[$key]['lastname'] ;?></td>
						        <td><?php  echo $admin_users[$key]['email'] ;?></td>
						        <td><?php  echo $admin_users[$key]['balence'] ;?></td>
						        <td><?php  echo $admin_users[$key]['joined'] ;?></td>
						        <td class="center"><a data-dismiss="modal" class="btn btn-primary" href="job_singel_view.php?post_id=<?php echo $admin_users[$key]['user_id'] ;?>">View</a> </td>
						        <td ><a  worker-id="<?php echo $admin_users[$key]['user_id'] ;?>" class="btn btn-danger delete_worker" href="javascript:void(0)"><i class="glyphicon glyphicon-trash"></i>Delete</a>
 ...
 $(document).ready(function(){
    ...
    $('.delete_worker').click(function(e){

      e.preventDefault();
      
      var pid = $(this).attr('worker-id');
