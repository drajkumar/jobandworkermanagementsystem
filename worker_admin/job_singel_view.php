					...
					<div class="panel-heading">Job details</div>
                        ...
                        foreach ($admin_users as $key => $value):
                           ...
                           ?>
                       		    ...
                       		    <h1 class="center"><?php  echo $admin_users[$key]['job_title'] ;?></h1>
						        <p><?php  echo $admin_users[$key]['job_price'] ;?><p>
						        <p><?php  echo $admin_users[$key]['job_description'] ;?></p>
						        <p><?php  echo $admin_users[$key]['job_catagori'] ;?></p>
