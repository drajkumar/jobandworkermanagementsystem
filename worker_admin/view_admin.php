...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
           ...
           ?> 
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">View admin user</div>
					<div class="panel-body">
						<table class="table table-striped">
						    <thead>
						    <tr>

						        <th data-field="id" data-sortable="true">User No</th>
						        <th data-field="name"  data-sortable="true">Username</th>
						        <th data-field="price" data-sortable="true">Password</th>
						    ...
						    <tr>
                                ...
                                $admin = new Admin();
                                $x = 0;
                                  $admin_users = $admin->selectAll('admin_user');
                                  foreach ($admin_users as $key => $value):
                               	$x++;  
                               	 ?>
						        <td><?php echo $x;  ?></td> 
						        <td><?php  echo $admin_users[$key]['username'] ;?></td>
						        <td><?php  echo $admin_users[$key]['password'] ;?></td>
						        
						        
						        <td ><a  admin-id="<?php echo $admin_users[$key]['id'] ;?>" class="btn btn-danger delete_admin_user" href="javascript:void(0)"><i class="glyphicon glyphicon-trash"></i>Delete</a>
 ...
 $(document).ready(function(){
    ...
    $('.delete_admin_user').click(function(e){

      e.preventDefault();
      
      var pid = $(this).attr('admin-id');
