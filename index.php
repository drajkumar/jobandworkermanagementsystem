				...
				<div class="row al-table">
					<div class="al-table-part">
						<table style="width:100%">
							  ...
							  <?php
                               $jobs = $user->selectAllUid('jobs', 'job_id');
							  ...
							  <tr>
							    <td><a href="dojob.php?job_unique_id=<?php echo $jobs[$key]['job_unique_id']; ?>&token=<?php echo Token::generete(); ?>"><?php echo $jobs[$key]['job_title'];?></a></td>
							    <td>$<?php echo $jobs[$key]['job_price'];?></td>						  
							    <td><?php
							     $job_id = $jobs[$key]['job_id'];
							      $count = $user->jobDoneCount($job_id);
                                 echo $count;
                               

                                 ?>
							    <sup><?php echo $jobs[$key]['target'];?></sup></td>				    
							  </tr>
